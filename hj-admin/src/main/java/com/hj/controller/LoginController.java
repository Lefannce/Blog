...
import com.hj.domain.VO.AdminUserInfoVo;
import com.hj.domain.VO.RoutersVo;
import com.hj.domain.VO.UserInfoVo;
import com.hj.domain.entity.LoginUser;
...
import com.hj.serivce.LoginService;
...
public class LoginController {
    ...
    public ResponseResult<AdminUserInfoVo> getInfo(){
        ...
        UserInfoVo AdminUserInfoVo = BeanCopyUtils.copyBean(user, UserInfoVo.class);

        //封装数据返回
        AdminUserInfoVo adminUserInfoVo = new AdminUserInfoVo(perms, roleKeyList,AdminUserInfoVo);
